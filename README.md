...
The **Trending Overview** dashboard provides a high-level view of YouTube trending content and its overall performance across regions and time periods.

It is based on the `trending_analytics` Gold dataset.

The dashboard answers the following business questions:

- **How much content is trending?**  
  The **Trending Videos** KPI shows the total number of trending videos analyzed.

- **How large is the audience?**  
  The **Total Views** KPI shows the total audience generated by trending content.

- **How engaged is the audience?**  
  The **Engagement Rate** KPI measures the level of interaction relative to the number of views.

- **Where is the audience concentrated?**  
  The **Views by Region** chart compares total views across regions.
...
These filters allow users to dynamically analyze the same KPIs for a specific geographical market or time period.
...
The **Channel Performance** dashboard analyzes how individual YouTube channels perform.
...
- channels generating the highest number of views;
- channels with the strongest engagement;
- differences between audience size and engagement performance.
...
The **Category Analysis** dashboard analyzes the performance of YouTube content categories.

It is based on the `category_analytics` Gold dataset.

Its objective is to identify:

- the most represented trending categories;
- the categories generating the highest number of views;
- the categories with the strongest engagement;
- differences in content performance across regions and time periods.
